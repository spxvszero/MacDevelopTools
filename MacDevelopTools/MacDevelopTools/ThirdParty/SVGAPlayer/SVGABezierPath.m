...
//            [self relativeMoveToPoint:iPoint];
        }
    }
...
//            [self addLineToPoint:iPoint];
            [self lineToPoint:iPoint];
//            [self relativeLineToPoint:iPoint];
        }
    }
...
//            [self addCurveToPoint:iiiPoint controlPoint1:iPoint controlPoint2:iiPoint];
            [self curveToPoint:iiiPoint controlPoint1:iPoint controlPoint2:iiPoint];
//            [self relativeCurveToPoint:iiiPoint controlPoint1:iPoint controlPoint2:iiPoint];
        }
    }
...
//            [self addQuadCurveToPoint:iiPoint controlPoint:iPoint];
            [self quadCurveToPoint:iiPoint controlPoint:iPoint];
//            [self relativeQuadCurveToPoint:iiPoint controlPoint:iPoint];
        }
    }
...
//            [self addLineToPoint:CGPointMake(iValue, self.currentPoint.y)];
            [self lineToPoint:CGPointMake(iValue, self.currentPoint.y)];
//            [self relativeLineToPoint:CGPointMake(iValue, self.currentPoint.y)];
        }
    }
...
//            [self addLineToPoint:CGPointMake(self.currentPoint.x, iValue)];
            [self lineToPoint:CGPointMake(self.currentPoint.x, iValue)];
//            [self relativeLineToPoint:CGPointMake(self.currentPoint.x, iValue)];
        }
    }
