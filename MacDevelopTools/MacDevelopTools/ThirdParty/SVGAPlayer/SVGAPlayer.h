...
typedef enum : NSUInteger {
    SVGAContentModeScaleAspectFit,
    SVGAContentModeScaleAspectFill,
    SVGAContentModeTop,
    SVGAContentModeBottom,
    SVGAContentModeLeft,
    SVGAContentModeRight,
} SVGAContentMode;

@interface SVGAPlayer : NSView

@property(nonatomic, assign) SVGAContentMode contentMode;
...
@property(nonatomic, assign, readonly) BOOL isOnAnimation;
...
- (void)setImage:(NSImage *)image forKey:(NSString *)aKey referenceLayer:(CALayer *)referenceLayer; // deprecated from 2.0.1
